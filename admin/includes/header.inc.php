...
<head>
    ...
    <title>PHPLoversBlog - Admin</title>
...
<body>
    <div class="container">
        <header class="blog-header py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                ...
                <div class="col-4 text-center">
                    <a class="blog-header-logo text-dark" href="#">PHPLover's Blog</a>
                </div>
        ...
        <?php if (isset($_GET['msg'])) : // if the form returns a message, show it
        ?>
            <div class="alert alert-info">
                <?= urldecode(htmlentities($_GET['msg'])) ?>
            </div>
        <?php endif; ?>